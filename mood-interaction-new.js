...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (submitButton && textarea) {
        submitButton.addEventListener('click', function() {
            ...
            if (activeCard) {
                selectedMood = activeCard.querySelector('span').textContent;
            } else if (textarea.value.trim() !== '') {
                selectedMood = textarea.value.trim();
            }
                ...
                allMoodCards.forEach(card => {
                    if (!card.classList.contains('add')) {
                        ...
                        // 如果是自定义情绪卡片
                            ...
                            const container = card.querySelector('.emotion-content');
                            if (container) {
                                ...
                                const deleteBtn = container.querySelector('.delete-emotion-btn');
                                if (deleteBtn) {
                                    deleteBtn.style.color = '#fff';
                                }
                            }
